import characterCount from '../bootcamp/character-count';
...
describe(`characterCount()`, () => {
	...
	it(`should return a object with character counts when taking a string with numerical characters`, () => {
		const str = 'aabbccddefgh11222'
		const expected = {
			'a': 2,
			'b': 2,
			'c': 2,
